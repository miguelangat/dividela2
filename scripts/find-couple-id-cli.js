...
/**
 * Dividela - Find Couple ID Helper (CLI version)
 *
 * Usage:
 *   node find-couple-id-cli.js your-email@example.com
 */
...
async function main() {
  ...
  if (!email) {
    console.log('Usage: node find-couple-id-cli.js your-email@example.com');
    process.exit(1);
  }
  ...
  try {
    ...
    console.log(`   node cleanup-data-cli.js ${coupleInfo.coupleId}`);
    console.log('');
