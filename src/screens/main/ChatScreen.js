...
export default function ChatScreen() {
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyTitle}>Welcome to Budget Chat!</Text>
      <Text style={styles.emptySubtitle}>
        I can help you manage expenses and budgets using natural language.
      </Text>
      <Text style={styles.emptyHint}>
        Try asking me to:
      </Text>
      <View style={styles.examplesList}>
        <Text style={styles.exampleItem}>• "Add $50 for groceries"</Text>
        <Text style={styles.exampleItem}>• "Show my budget status"</Text>
        <Text style={styles.exampleItem}>• "What's our balance?"</Text>
        <Text style={styles.exampleItem}>• "How much left in food budget?"</Text>
      </View>
    </View>
  );
